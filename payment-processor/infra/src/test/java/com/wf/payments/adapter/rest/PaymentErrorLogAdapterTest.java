package com.wf.payments.adapter.rest;

import com.wf.payments.adapter.rest.client.PaymentErrorLogAdapter;
...
class PaymentErrorLogAdapterTest {
    ...
    void should_throw_exception_and_log_if_service_takes_more_than_timeout() {
        ...
        // then
        assertThrows(LogPaymentErrorException.class, () -> serviceUnderTest.sendErrorToLogSystem(paymentError));
    }
